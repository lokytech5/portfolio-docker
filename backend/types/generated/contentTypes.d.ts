...
export interface ApiCloudTechnologieCloudTechnologie
  extends Schema.CollectionType {
  collectionName: 'cloud_technologies';
  info: {
    singularName: 'cloud-technologie';
    pluralName: 'cloud-technologies';
    displayName: 'Cloud Technologie';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::cloud-technologie.cloud-technologie',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiFrameworkFramework extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::cloud-technologie.cloud-technologie': ApiCloudTechnologieCloudTechnologie;
